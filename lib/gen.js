...
function gen_level(out, level) {
  ...
  out.block(() => {
    ...
    out.block(() => {
      out.line('if (!uses[name]) throw new Error(`\'${name}\' is not declared as a dependency of \'${forName}\'`)')
      out.line(`var getter = self['_get_' + name]`)
      out.line('var future = new Future')
      out.line('poll.poll(future, self, getter)')
  ...
  out.block(() => {
    out.line('var future = new Future')
    out.line('poll.poll(future, this)')
    out.line('return future')
  })
}
