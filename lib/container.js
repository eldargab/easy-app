...
/**
 * Hash for storing task evaluation results
 *
 * @api private
 */
...
/**
 * Create/get `.values` object for the current instance (layer)
 *
 * @api private
 */
...
/**
 * Hash for storing promises for pending evaluations
 *
 * @api private
 */
...
/**
 * Create/get `.promises` object for the current instance (layer)
 *
 * @api private
 */
...
/**
 * Hash for storing task definitions
 *
 * @api private
 */
...
/**
 * Create/get `.tasks` object for the current instance (layer)
 *
 * @api private
 */
...
/**
 * Create/get `.aliases` object for the current instance (layer)
 *
 * @api private
 */
...
/**
 * Create/get `._imports` object for the current instance
 *
 * @api private
 */
...
/**
 * Checks whether the app imports given task
...
/**
 * Gets a value of a given task (if available)
 *
 * @param {String} Task name
 * @return {Mixed} Value
 * @api public
